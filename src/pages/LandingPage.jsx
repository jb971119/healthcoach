    ...
    <div className="min-h-screen bg-gray-50 text-gray-900 font-sans">
      ...
      <header className="bg-gradient-to-r from-blue-700 to-blue-500 text-white py-24 px-4 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl mb-10 opacity-90 font-light">
            대한운동사협회 &amp; 한국영양학회 기준의 검증된 커리큘럼 기반
            헬스케어
          </p>
          <button
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          >
            ...
            <p className="text-gray-500 text-sm">
              전문가가 나의 식습관을 분석하고 맞춤 식단을 제안해드립니다.
            </p>
            <span className="text-blue-600 text-sm font-semibold mt-4 block group-hover:underline">
              신청하기 →
            </span>
          </button>
          ...
          >
            ...
            <p className="text-gray-500 text-sm">
              가입하고 식단 분석, 운동 피드백 등 모든 기능을 이용하세요.
            </p>
            <span className="text-green-600 text-sm font-semibold mt-4 block group-hover:underline">
              가입하기 →
            </span>
          </button>
          ...
          >
            ...
            <p className="text-gray-500 text-sm">
              사진 한 장으로 AI가 체형을 분석하고 맞춤 운동을 추천합니다.
            </p>
            <span className="text-orange-600 text-sm font-semibold mt-4 block group-hover:underline">
              분석하기 →
            </span>
          </button>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            >
              ...
              <p className="opacity-80 text-sm">
                식사 사진을 올리면 AI가 칼로리·영양소를 분석하고 추천 식단을
                알려드립니다.
              </p>
            </button>
            <button
      ...
      <section className="bg-blue-900 text-white py-12 px-6 text-center">
        ...
        <p className="text-blue-200">
          무료 체험 신청자 중 추첨을 통해 스타벅스 커피 쿠폰을 드립니다!
        </p>
        <button
          onClick={() => navigate("/apply")}
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-white p-10 rounded-3xl shadow-sm border border-gray-100 hover:shadow-md transition">
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              피트니스 지도사와 공인영양사가 팀을 이루어 설계합니다. 학회 기준에
              맞춘 정밀한 프로그램을 경험하세요.
            </p>
          </div>
          <div className="bg-white p-10 rounded-3xl shadow-sm border border-gray-100 hover:shadow-md transition">
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              1:1 인바디 분석 데이터를 바탕으로 매주 '주간 리포트'를 발행합니다.
              데이터로 증명되는 신체 변화를 확인하세요.
            </p>
          </div>
        </div>
      </section>
